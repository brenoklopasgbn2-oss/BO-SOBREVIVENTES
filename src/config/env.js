...
export const env = {
  ...
  appName: optional('APP_NAME', 'DayZ Store'),
  ...
  allowLegacyGameSteam64Login: ['1', 'true', 'yes', 'sim', 'on'].includes(optional('ALLOW_LEGACY_GAME_STEAM64_LOGIN', 'false').trim().toLowerCase()),
  ...
  discordWebhookName: optional('DISCORD_WEBHOOK_NAME', 'DayZ Store • Logs'),
  discordWebhookAvatarUrl: optional('DISCORD_WEBHOOK_AVATAR_URL'),
  currencyName: optional('STORE_CURRENCY_NAME', 'Coins'),
