...
const CATEGORY_DEFINITIONS = [
  ...
  },
  {
    ...
    channels: [
      ...
      { type: 'text', name: CHANNELS.sacoDeDormir, aliases: CHANNEL_ALIASES[CHANNELS.sacoDeDormir], topic: 'Saco de dormir: No Raid somente na base principal e sem FOB; jogadores de raid usam em FOB ou fora da base principal.', readOnly: true },
