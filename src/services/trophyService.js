...
export const AUTOMATIC_TROPHY_CATALOG = [
  metricTrophy({
    ...
    description: "Registre sua primeira eliminação no ZONA-Z.",
    icon: "☠",
  ...
  metricTrophy({
    ...
    description: "Chegue a 1.000 eliminações no ZONA-Z.",
    icon: "☠",
  ...
  metricTrophy({
    key: "RAIDZ_LEGEND",
    title: "Lenda do ZONA-Z",
    shortTitle: "Lenda ZONA-Z",
  ...
  },
  {
    ...
    description: "Complete a jornada máxima de combate do ZONA-Z.",
    icon: "★",
