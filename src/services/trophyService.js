...
export const AUTOMATIC_TROPHY_CATALOG = [
  metricTrophy({
    ...
    description: "Registre sua primeira eliminação no servidor.",
    icon: "☠",
  ...
  metricTrophy({
    ...
    description: "Chegue a 1.000 eliminações no servidor.",
    icon: "☠",
  ...
  metricTrophy({
    key: "RAIDZ_LEGEND",
    title: "Lenda do Servidor",
    shortTitle: "Lenda do Servidor",
    description: "Conquiste 2.500 eliminações e entre para a história.",
    icon: "☠",
    imageUrl: "/images/ranking/trophies/zona-z-legend.svg",
    color: "#e879f9",
    points: 6000,
    tier: 10,
    rarity: "Mítico",
  ...
  },
  {
    ...
    description: "Complete a jornada máxima de combate do servidor.",
    icon: "★",
