...
const CHANNELS = {
  ...
  purchaseLogs: '🧾・compras-site',
  linkAlerts: '⚠️・sem-vinculo',
...
const CHANNEL_ALIASES = {
  ...
  [CHANNELS.championship]: ['campeonato', 'ranking-campeonato', 'resultados-campeonato'],
  [CHANNELS.linkAccount]: ['vincular-conta', 'vincular', 'link-conta'],
  [CHANNELS.purchaseLogs]: ['compras-site', 'compras', 'pagamentos-site'],
  [CHANNELS.linkAlerts]: ['sem-vinculo', 'alerta-vinculo', 'alertas-vinculo'],
...
const CATEGORY_DEFINITIONS = [
  ...
  },
  {
    ...
    channels: [
      ...
      { type: 'text', name: CHANNELS.championship, aliases: CHANNEL_ALIASES[CHANNELS.championship], topic: 'Resultados oficiais, campeões e pontuação da temporada CHAMPIONS Z.', readOnly: true },
  ...
  },
  {
    ...
    channels: [
      ...
      { type: 'text', name: CHANNELS.linkAccount, aliases: CHANNEL_ALIASES[CHANNELS.linkAccount], topic: 'Gere seu código privado para vincular Discord ↔ Steam no site.', readOnly: true },
